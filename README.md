...
### 1. 공동 화이트보드
![1  공동 화이트보드](https://github.com/user-attachments/assets/1a56687c-8731-405b-afca-530bc500c385)
- 작성한 그림이나 메모가 메인 화면과 실시간으로 동기화
- 여러 사용자가 동시에 편집 가능
  
### 2. 인터랙티브 실시간 투표
![2  인터랙티브 실시간 투표](https://github.com/user-attachments/assets/13b2d3c4-ee0f-4bc4-9910-c1b9a8ffb23b)
- 참여자의 선택 결과가 실시간으로 집계
- 투표 결과는 차트 등 시각적 요소로 표현

### 3. 실시간 협업 캘린더
![3  실시간 협업 캘린더](https://github.com/user-attachments/assets/0cd4b43a-4318-418b-901f-acb14187ca41)
- 회의 중 논의된 일정이나 마일스톤을 캘린더 형태로 시각화
- 일정 추가·수정·삭제 시 회의 참여자 화면에 실시간으로 동기화
